...
var buildfn = function(checksfile) {
     var response2console = function(result,response)
     {
          ...
          else
          {
            ...
            var out = {};
            for(var cnt in checks)
            {
              var present = $(checks[cnt]).length >0;
              out[checks[cnt]] = present;
            }
            var outJ =   JSON.stringify(out,null,2);    
            console.log(outJ);  
          }    
...
if(require.main == module) {
    program
        ...
        .option('-u, --url  <html_url>' , 'Pth to index.html url',null, null)
